 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Sway | Ctrl | GUI  | Alt  | Lower|    Space    |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  TD(TD_HAEN_HANJ), _______, _______, _______, _______, _______, _______, _______, KC_MSTP, KC_MNXT, KC_MPRV, KC_MPLY  \
),
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      | Reset| Debug|RGB To|RGB Mo|RGB H+|RGB H-|RGB S+|RGB S-|RGB B+|RGB B-|  Del |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
