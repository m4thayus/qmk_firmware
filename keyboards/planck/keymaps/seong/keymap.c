 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Fn   | Ctrl | Sway | Alt  | Lower|    Space    |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    SWAY, KC_LCTL, KC_LGUI, KC_LALT, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, KC_F7,   KC_F8,   KC_F9,    KC_F10,  KC_F11,  KC_F12,  _______,    _______,  KC_UNDS, KC_PLUS,  _______,
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______,  KC_MUTE, KC_VOLD, KC_VOLU, _______, KC_BRID, KC_BRIU, _______, _______, KC_LBRC, KC_RBRC, KC_BSLS,
